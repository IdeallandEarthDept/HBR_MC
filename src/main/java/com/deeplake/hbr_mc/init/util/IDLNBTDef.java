...
public class IDLNBTDef {
	...
	public static final String IMPRINT_DESC = Main.MODID+".imprint.desc";
    ...
    public static final int CUR_STARTER_KIT_VERSION = 6;
   ...
   // public static final String INIT_DONE = "inited";
    ...
    public static final String KEY_BREAK_THRU = BREAKTHROUGH;
	...
	public static final String KEY_SERAPH_RETRIEVE_DAMAGE = "hbrmc_srph_ret_dmg";
