...
public class RegisterBlocks {
    ...
    public static final Block INST_ST_GUITAR = new BlockComplexDeco("inst_st_guitar");
    public static final Block INST_BED_DOUBLE = new BlockComplexDeco("inst_bed_double");
    public static final Block INST_MICROPHONE = new BlockComplexDeco("inst_microphone");
    public static final Block INST_MICROPHONE_SEATED = new BlockComplexDeco("inst_microphone_seated");
    public static final Block INST_MICROPHONE_IN_HAND = new BlockComplexDeco("inst_microphone_in_hand");
    public static final Block INST_DRUM_SET = new BlockComplexDeco("inst_drum_set");
    public static final Block INST_WOOD_GUITAR = new BlockComplexDeco("inst_wood_guitar");
    public static final Block INST_BASS = new BlockComplexDeco("inst_bass");
    public static final Block INST_KEYBOARD = new BlockComplexDeco("inst_keyboard");
    public static final Block INST_SPEAKER = new BlockComplexDeco("inst_speaker");
