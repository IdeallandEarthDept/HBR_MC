...
package com.deeplake.hbr_mc.designs.danmaku.after2024.brotli.dec;

import com.deeplake.hbr_mc.designs.danmaku.after2024.brotli.dec.*;
import com.deeplake.hbr_mc.designs.danmaku.after2024.brotli.dec.State;
import com.deeplake.hbr_mc.designs.danmaku.after2024.brotli.dec.Utils;

import static com.deeplake.hbr_mc.designs.danmaku.after2024.brotli.dec.RunningState.BLOCK_START;
import static com.deeplake.hbr_mc.designs.danmaku.after2024.brotli.dec.RunningState.CLOSED;
import static com.deeplake.hbr_mc.designs.danmaku.after2024.brotli.dec.RunningState.COMPRESSED_BLOCK_START;
import static com.deeplake.hbr_mc.designs.danmaku.after2024.brotli.dec.RunningState.COPY_LOOP;
import static com.deeplake.hbr_mc.designs.danmaku.after2024.brotli.dec.RunningState.COPY_UNCOMPRESSED;
import static com.deeplake.hbr_mc.designs.danmaku.after2024.brotli.dec.RunningState.COPY_WRAP_BUFFER;
import static com.deeplake.hbr_mc.designs.danmaku.after2024.brotli.dec.RunningState.FINISHED;
import static com.deeplake.hbr_mc.designs.danmaku.after2024.brotli.dec.RunningState.INSERT_LOOP;
import static com.deeplake.hbr_mc.designs.danmaku.after2024.brotli.dec.RunningState.MAIN_LOOP;
import static com.deeplake.hbr_mc.designs.danmaku.after2024.brotli.dec.RunningState.READ_METADATA;
import static com.deeplake.hbr_mc.designs.danmaku.after2024.brotli.dec.RunningState.TRANSFORM;
import static com.deeplake.hbr_mc.designs.danmaku.after2024.brotli.dec.RunningState.UNINITIALIZED;
import static com.deeplake.hbr_mc.designs.danmaku.after2024.brotli.dec.RunningState.WRITE;
...
final class Decode {
  ...
  private static void decodeMetaBlockLength(BitReader br, com.deeplake.hbr_mc.designs.danmaku.after2024.brotli.dec.State state) {
  ...
  private static void readHuffmanCodeLengths(
    ...
    com.deeplake.hbr_mc.designs.danmaku.after2024.brotli.dec.Utils.fillWithZeroes(codeLengths, symbol, numSymbols - symbol);
  }
  ...
  private static int decodeContextMap(int contextMapSize, byte[] contextMap, BitReader br) {
    ...
    if (numTrees == 1) {
      com.deeplake.hbr_mc.designs.danmaku.after2024.brotli.dec.Utils.fillWithZeroes(contextMap, 0, contextMapSize);
      return numTrees;
    }
  ...
  private static void decodeBlockTypeAndLength(com.deeplake.hbr_mc.designs.danmaku.after2024.brotli.dec.State state, int treeType) {
  ...
  private static void decodeLiteralBlockSwitch(com.deeplake.hbr_mc.designs.danmaku.after2024.brotli.dec.State state) {
  ...
  private static void decodeCommandBlockSwitch(com.deeplake.hbr_mc.designs.danmaku.after2024.brotli.dec.State state) {
    decodeBlockTypeAndLength(state, 1);
    state.treeCommandOffset = state.hGroup1.trees[state.blockTypeRb[3]];
  }

  private static void decodeDistanceBlockSwitch(com.deeplake.hbr_mc.designs.danmaku.after2024.brotli.dec.State state) {
    decodeBlockTypeAndLength(state, 2);
    state.distContextMapSlice = state.blockTypeRb[5] << DISTANCE_CONTEXT_BITS;
  }

  private static void maybeReallocateRingBuffer(com.deeplake.hbr_mc.designs.danmaku.after2024.brotli.dec.State state) {
   ...
   */
  private static void readMetablockInfo(com.deeplake.hbr_mc.designs.danmaku.after2024.brotli.dec.State state) {
    final BitReader br = state.br;
  ...
  private static void readMetablockHuffmanCodesAndContextMaps(com.deeplake.hbr_mc.designs.danmaku.after2024.brotli.dec.State state) {
    final BitReader br = state.br;
  ...
  private static void copyUncompressedData(com.deeplake.hbr_mc.designs.danmaku.after2024.brotli.dec.State state) {
    final BitReader br = state.br;
  ...
  private static boolean writeRingBuffer(com.deeplake.hbr_mc.designs.danmaku.after2024.brotli.dec.State state) {
  ...
  static void setCustomDictionary(com.deeplake.hbr_mc.designs.danmaku.after2024.brotli.dec.State state, byte[] data) {
   ...
   */
  static void decompress(com.deeplake.hbr_mc.designs.danmaku.after2024.brotli.dec.State state) {
