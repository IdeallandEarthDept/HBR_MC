...
public class BrotliInputStream extends InputStream {
   ...
   * Decoder state.
   */
  private final com.deeplake.hbr_mc.designs.danmaku.after2024.brotli.dec.State state = new com.deeplake.hbr_mc.designs.danmaku.after2024.brotli.dec.State();
  ...
  public BrotliInputStream(InputStream source, int byteReadBufferSize,
    ...
    this.bufferOffset = 0;
    try {
      com.deeplake.hbr_mc.designs.danmaku.after2024.brotli.dec.State.setInput(state, source);
    } catch (BrotliRuntimeException ex) {
      throw new IOException("Brotli decoder initialization failed", ex);
    }
    if (customDictionary != null) {
      com.deeplake.hbr_mc.designs.danmaku.after2024.brotli.dec.Decode.setCustomDictionary(state, customDictionary);
    }
  }
  ...
  public void close() throws IOException {
    com.deeplake.hbr_mc.designs.danmaku.after2024.brotli.dec.State.close(state);
  }
  ...
  public int read(byte[] destBuffer, int destOffset, int destLen) throws IOException {
    ...
    try {
      ...
      state.outputUsed = 0;
      com.deeplake.hbr_mc.designs.danmaku.after2024.brotli.dec.Decode.decompress(state);
