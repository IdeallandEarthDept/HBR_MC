...
import com.deeplake.hbr_mc.client.models.entities.ModelCrestHopper;
...
public class RenderCrestHopper extends RenderLiving<EntityCrestHopper> {
    public static final ResourceLocation TEXTURES = new ResourceLocation(Main.MODID + ":textures/models/cancer/crest_hopper.png");
    public RenderCrestHopper(RenderManager rendermanagerIn) {
        super(rendermanagerIn, new ModelCrestHopper(), 1.6f);
    }
