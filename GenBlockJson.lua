...
-- local array = {"Na","K","Cs"}
-- local array2 = {"CO3","ClO4","SO4"}
-- --
-- for i = 0, 2 do
-- for j = 0, 2 do
-- 	GenItem("misc", array[i].."_"..array2[j]);
-- end
-- end
--
--for i = 8, 11 do
...
for i = 1, 6 do
	GenBlock("color_"..color[i]);
	GenBlock("indes_"..color[i]);
	GenBlock("light_"..color[i]);
end
--
-- GenItem("weapon", "speaker_gun")
